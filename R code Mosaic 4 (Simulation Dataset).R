...
ggplot(posterior_df_long, aes(x = Beta, fill = Marker)) +
  ...
  labs(title = "Posterior Density Plots (Simulated Data)", x = "Beta", y = "Density") +
  theme_minimal() +
...
png(filename = "plots/simulated_mcmc_diagnostics.png")
par(mfrow = c(2, 2))
