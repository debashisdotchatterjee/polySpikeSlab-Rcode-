...
png(filename =### Updated R Code for Simulation and Plotting

Here's the updated R code to simulate data, perform Bayesian fine-mapping, and generate the required plots, ensuring each diagnostic plot is created individually and the true beta lines are included in the density plots.
